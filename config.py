...
class Config(object):
    ...
    BLOB_STORAGE_KEY = os.environ.get('BLOB_STORAGE_KEY') or 'scD2tF5J0pJmb33bOzrcgxr7gdXdXx0cMoKBdSV4Okok7JcOEzCCx+mb2B/d+HtNpGbhPIUN6sVczxq7lADQqQ=='
    ...
    CLIENT_SECRET = "TkNH1y2aao_~cudz~v1.16y6~s8W2aje1Z"
    ...
    CLIENT_ID = "a3eb8625-f89d-4f64-8366-83bd981ccaee"
